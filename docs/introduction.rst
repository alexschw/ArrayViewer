...
Data Tree
=========
The Data Tree contains the loaded data. The structure of the tree represents the structure of the loaded data. Right-click on any to rename, reshape or delete it in the tree. These operations will not change the original file! If you select any value without a child value its representation will appear in the Charts View.
